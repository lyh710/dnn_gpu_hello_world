...
seq.fit(train, train, batch_size=4, epochs=3, shuffle=False, callbacks=[tensorboard, history, time_callback])
...
pickle.dump((times_per_sample, times_per_epoch, train_time), open('time_cpu.pkl', 'wb'))

pkl_fn = open(log_dir+'/'+version+'/'+'log.pkl', 'wb')
